...
function MakeBreadCrumb() {
    ...
    if (!abc) {
        //console.log("current file name deducted:" + CurrentFileName() + "; can't find parent path in tree.js for this fragment");
        return;
    }
...
function CurrentFileName(){
	return document.getElementById("file_name").innerHTML
}
